...
public sealed class BuyumeAnalitikController : ControllerBase
{
    private readonly ILogger<BuyumeAnalitikController> _logger;
    private readonly CommerceMetricsAccumulator _metrics;

    public BuyumeAnalitikController(ILogger<BuyumeAnalitikController> logger, CommerceMetricsAccumulator metrics)
    {
        _logger = logger;
        _metrics = metrics;
    }
    ...
    public IActionResult Ingest([FromBody] BuyumeOlayYuk? payload)
    {
        ...
        var safe = BuyumeOlayYuk.Normalize(payload, HttpContext);
...
public sealed class BuyumeOlayYuk
{
    ...
    public static BuyumeOlayYuk Normalize(BuyumeOlayYuk p, HttpContext httpContext)
    {
