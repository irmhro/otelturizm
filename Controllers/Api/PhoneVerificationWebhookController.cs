...
public class PhoneVerificationWebhookController : ControllerBase
{
    private readonly IPhoneVerificationService _phoneVerificationService;

    public PhoneVerificationWebhookController(IPhoneVerificationService phoneVerificationService)
    {
