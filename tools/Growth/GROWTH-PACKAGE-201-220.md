...
Bu dosya `Dokumanlar/Arsiv/ilk-200-gelistirme-plani.md` içindeki **201–220** maddelerinin depoda hangi bileşenlere karşılık geldiğini özetler.
...
| 204–205 | Funnel / rage / dead | `wwwroot/assets/js/growth-analytics.js`, `Controllers/Api/BuyumeAnalitikController.cs` |
