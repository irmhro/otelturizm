...
- **Kritik**: Otel/oda ile iliskili tum medya/dosya path'leri **otel adina gore degil**, kalici kimlik olan **`otelId`** bazinda klasorlenmelidir.
  - Otel adi degisse bile URL/dosya yolu bozulmamalidir.
  - Ornek public upload yapisi (partner/admin dahil):
    - `wwwroot/uploads/hotels/partner/{otelId}/...`
    - `wwwroot/uploads/hotels/partner/{otelId}/rooms/{odaTipId}/...`
    - `wwwroot/uploads/hotels/admin/{otelId}/...`
    - `wwwroot/uploads/hotels/admin/{otelId}/rooms/{odaTipId}/...`
  - Veritabaninda tutulan `gorsel_url` alanlari da ayni standarda uymali ve **otel adi icermemelidir**.
