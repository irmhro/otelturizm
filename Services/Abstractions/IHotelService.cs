...
public interface IHotelService
{
    ...
    Task<HotelListingPageViewModel> GetHotelListingPageAsync(string? searchTerm, string? campaignTag = null, string? campaignSlug = null, int page = 1, string? contextualSearchBoostNormalized = null, CancellationToken cancellationToken = default);
