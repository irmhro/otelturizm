...
public interface IAdminService
{
    ...
    Task<AdminPartnerApplicationDetailPageViewModel?> GetPartnerApplicationDetailAsync(long partnerId, string fullName, string email, string userRole, long adminUserId, CancellationToken cancellationToken = default);
