...
DECLARE @token nvarchar(200) = N'81ee21abd59441cc8b1b691a849fcba0d9c70cab01b84909b864a68dc6905056';
DECLARE @code nvarchar(20) = N'546923';
DECLARE @verificationLink nvarchar(max) = N'https://otelturizm.com/eposta-dogrula?email=irmhro0%40gmail.com&token=81ee21abd59441cc8b1b691a849fcba0d9c70cab01b84909b864a68dc6905056&code=546923';
...
VALUES
(@userId, @email, @token, @code, 0, 0, 5, N'185.111.244.246', N'Codex smtp verification test', DATEADD(HOUR, 24, SYSUTCDATETIME()), SYSUTCDATETIME());
