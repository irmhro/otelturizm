...
DECLARE @verificationLink nvarchar(max) = N'https://localhost:7223/eposta-dogrula?email=irmhro0%40gmail.com&token=1df0cda7a0004f1db6e6c51bad5a1f1213ad59b4c5754966997258ad43b7a621&code=398265';
...
VALUES
(@userId, @email, @token, @code, 0, 0, 5, N'127.0.0.1', N'Codex manual verification test', DATEADD(HOUR, 24, SYSUTCDATETIME()), SYSUTCDATETIME());
