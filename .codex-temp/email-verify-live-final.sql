...
DECLARE @token nvarchar(200) = N'60e2bb51c72b4aaba30b5b6bfaa97f2413869179b3054ee08bef71f534f4a70f';
DECLARE @code nvarchar(20) = N'614793';
DECLARE @verificationLink nvarchar(max) = N'https://otelturizm.com/eposta-dogrula?email=irmhro0%40gmail.com&token=60e2bb51c72b4aaba30b5b6bfaa97f2413869179b3054ee08bef71f534f4a70f&code=614793';
...
VALUES
(@userId, @email, @token, @code, 0, 0, 5, N'185.111.244.246', N'Codex final verification test', DATEADD(HOUR, 24, SYSUTCDATETIME()), SYSUTCDATETIME());
