...
BEGIN
    ALTER TABLE [dbo].[AKILLI_ROTA_OTELLER] WITH CHECK ADD CONSTRAINT [FK_AKILLI_ROTA_OTELLER_ROTA] FOREIGN KEY ([AKILLI_ROTA_ID]) REFERENCES [dbo].[AKILLI_ROTA] ([ID]);
END
GO

IF OBJECT_ID(N'dbo.FK_AKILLI_ROTA_OTELLER_OTEL', N'F') IS NULL
BEGIN
    ALTER TABLE [dbo].[AKILLI_ROTA_OTELLER] WITH CHECK ADD CONSTRAINT [FK_AKILLI_ROTA_OTELLER_OTEL] FOREIGN KEY ([OTEL_ID]) REFERENCES [dbo].[OTELLER] ([ID]);
END
GO

IF OBJECT_ID(N'dbo.FK_AKILLI_ROTA_OTELLER_KULLANICI', N'F') IS NULL
BEGIN
    ALTER TABLE [dbo].[AKILLI_ROTA_OTELLER] WITH CHECK ADD CONSTRAINT [FK_AKILLI_ROTA_OTELLER_KULLANICI] FOREIGN KEY ([KULLANICI_ID]) REFERENCES [dbo].[KULLANICILAR] ([ID]);
END
GO
